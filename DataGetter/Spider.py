...
class MySpider:
    def __init__(self, api_flag:int):
    ...
    def GetHtml(self, url:str)->str:
        ...
        try:
            r = requests.get(url, timeout=7,headers = self.kv)
            r.raise_for_status()
    ...
    def GetCandidate(self, name:str)->(int, list):
    ...
    def GetPerform(self, wca_id:str)->dict:
        event2perform = {}
        comp = set()
        solv = 0
        ...
        html = self.GetHtml('https://cubingchina.com/results/person/%s'%wca_id)
